...
export class EventsContract__idToEventResult {
  value0: Bytes;
  value1: string;
  value2: Address;
  value3: BigInt;
...
export class EventsContract extends ethereum.SmartContract {
  static bind(address: Address): EventsContract {
    return new EventsContract("EventsContract", address);
  }

  idToEvent(param0: Bytes): EventsContract__idToEventResult {
    ...
    return new EventsContract__idToEventResult(
      result[0].toBytes(),
      result[1].toString(),
      result[2].toAddress(),
      result[3].toBigInt(),
  ...
  try_idToEvent(
    param0: Bytes
  ): ethereum.CallResult<EventsContract__idToEventResult> {
    ...
    return ethereum.CallResult.fromValue(
      new EventsContract__idToEventResult(
        value[0].toBytes(),
        value[1].toString(),
        value[2].toAddress(),
        value[3].toBigInt(),
